...
var Draft75Parser = require('faye-websocket/lib/faye/websocket/draft75_parser'),
    Draft76Parser = require('faye-websocket/lib/faye/websocket/draft76_parser'),
    HybiParser    = require('faye-websocket/lib/faye/websocket/hybi_parser'),
    API           = require('faye-websocket/lib/faye/websocket/api'),
    Event         = require('faye-websocket/lib/faye/websocket/api/event');
...
WebSocket.Client      = require('faye-websocket/lib/faye/websocket/client');
WebSocket.EventSource = require('faye-websocket/lib/faye/eventsource');
